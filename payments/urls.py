...
from .views import create_payment_intent, list_tickets
from .webhooks import stripe_webhook

urlpatterns = [
    # Stripe Connect endpoints
    path('stripe/balance/', AccountBalanceView.as_view(), name='stripe-balance'),
    path('stripe/transactions/', TransactionHistoryView.as_view(), name='stripe-transactions'),
    ...
    # Payment intents
    path('create-payment-intent/<int:gig_id>/', create_payment_intent, name='create-payment-intent'),
